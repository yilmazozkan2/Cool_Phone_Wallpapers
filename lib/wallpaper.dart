import 'dart:convert';
import 'package:android_enyeni_duvarkagitlari/widgets/wallpaper/grid_view_builder.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;

// Widgets
import 'widgets/wallpaper/banner_ad.dart';
import 'widgets/wallpaper/show_more_img_container.dart';
      ...
      home: Scaffold(
        ...
        body: Column(
          children: [
            BannerAdContainer(),
            Text(
                'Görseller pexels.com tarafından pexels api kullanılarak sağlanmaktadır'),
            Expanded(child: GridViewBuilder(images: images)),
            InkWell(
              onTap: () {
                loadmore();
              },
